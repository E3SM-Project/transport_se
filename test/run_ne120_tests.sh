...
ncl dcmip1-1_lat_lon.ncl    NE=120
ncl dcmip1-2_lat_height.ncl NE=120
...
ncl dcmip1-1_error_norm.ncl  NE=120 | tail -n 1
ncl dcmip1-2_error_norm.ncl  NE=120 | tail -n 1
echo
